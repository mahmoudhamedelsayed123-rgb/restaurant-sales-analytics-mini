-- ============================================================
-- Read-Only Pre-Execution Safety Check Query for Supabase SQL Editor
-- Purpose: Verify that all 55 foreign order_items targeted by cleanup_foreign_order_items.sql exist in Supabase
-- Expected Result: COUNT = 55
-- ============================================================

SELECT COUNT(*) AS existing_foreign_count
FROM order_items
WHERE id IN (
